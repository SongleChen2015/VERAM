...
--[[dataset]]
ds = ImageSet2DWithConf({train_file = './data/ModelNet10_AlexNetFC6_All144Views_Train.h5', validate_file='./data/ModelNet10_AlexNetFC6_All144Views_Test.h5', confidence_file = './data/ModelNet10_AlexNetFC6_All144Views_TrainData_Confidence.h5', height = 12, width=12, features = 4096, classnum = 10}) 
...
totalSuperParam = #_learningRate*#_minLR*#_weightStd*#_glimpseDropout*#_hiddenSize*#_locatorStd*#_rho
 ...
 for n,rho in ipairs(_rho) do
   ...
   strParam = string.format('m10AlexFC6LSTM-lr%f-minlr%f-wstd%.2f-drop%.2f-hid%d-lstd%.2f-rho%d',opt.learningRate, opt.minLR, opt.weightStd,opt.glimpseDropout,opt.hiddenSize, opt.locatorStd,opt.rho)
